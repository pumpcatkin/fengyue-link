...
结果：保存接口与导出回读接口均返回 HTTP 200；作品名称、简介、详细介绍、前置词、提示词、后置词和三个世界书条目逐项比对。该作品是一张游戏卡服务全体玩家的唯一伴生作品，玩家侧不填写或替换作品 ID。
...
世界书：3 条
详细介绍：23,775 字符
程序 SHA-256：5b4392a015fa5c71b49bf87a08daae8dfdb656b519ab5d914371c6102c67f1fe
```
