...
if (process.type === "renderer") {
  ...
  ipcMain.handle("qa:api", (_event, name, args) => {
    ...
    if (name === "listOnlineWorldCards") return { cards: [{ cardId: "cc.aiero.fyow.grid-conquest.official", gameId: "cc.aiero.fyow.grid-conquest", title: "艳猎征途", version: 4, workId: "b27218e6-80f9-4c0d-91c7-4b8f87d47be8", workName: "艳猎征途[b27218e680f94c0d]" }], activeCardId: null };
