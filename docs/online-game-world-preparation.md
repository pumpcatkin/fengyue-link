...
- “详细介绍”当前保存 34,542 字符的 `FYOW-PROGRAM/1` 信封，程序 SHA-256 为 `7bb8a7b2e53d154175d8da29ef884fd3127450e1716f0708bb01118c947bde72`；当前同步包含自由性癖标签、注释、偏好修改、加入流程互斥、七类将领资料、玩家/将领战力修炼、`fyow-host/1` 回包关联和分场景音效。
...
- 本轮新版程序保存与回读均为 HTTP 200；卡内规范化配置摘要为 `06897af7011e27b22220cfe84fb7d759de355cd11238fef5929cea94f4a5166d`，平台补齐内部字段后的导出摘要为 `878f8fa281bd7d441aeca8eda350c7bfd8d2723cea2c0ec2486833ad73b1d4c2`；服主控制记录 `8256a01b-a186-45f6-b86c-85c317381a06` 已启用该程序摘要。
...
1. 在固定伴生作品 `b27218e6-80f9-4c0d-91c7-4b8f87d47be8` 保存《猎艳疆土》程序信封、世界观和五个用户范围世界书，随后用完整游戏卡导出回读并对比摘要。
